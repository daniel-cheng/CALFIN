...
from aug_generators_no_scaling import aug_resize, aug_pad
...
def create_validation_data_from_directory():
	...
	for image_name in images:
		...
		img_padded = dat_padded['image']
		mask_padded = dat_padded['mask']
		
		patches, patches_mask = create_validation_data_from_image(img_padded, mask_padded, image_name, image_pred_name)
