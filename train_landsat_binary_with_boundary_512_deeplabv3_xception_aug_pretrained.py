...
if __name__ == '__main__':
	...
	clr_triangular = CyclicLR(mode='triangular2', step_size=8000, base_lr=8e-5, max_lr=4e-4)
	callbacks_list = [
	...
	model.compile(optimizer=AdamAccumulate(lr=1e-4, accum_iters=8), loss=bce_jaccard_loss, metrics=['binary_crossentropy', iou_score, 'accuracy'])
	model.summary()
