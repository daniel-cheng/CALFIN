...
#    preprocess_input = get_preprocessing(BACKBONE)
    ...
    model_checkpoint = ModelCheckpoint('landsat_weights_with_boundary_224_deeplabv3_xception_e{epoch:02d}_iou{val_iou_score:.4f}.h5', monitor='val_iou_score', save_best_only=False)
