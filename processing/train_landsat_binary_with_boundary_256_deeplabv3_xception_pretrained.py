...
def aug_daniel_part2(prob=1.0):
	return Compose([
		ShiftScaleRotate(shift_limit=.05, scale_limit=0.0, rotate_limit=15, border_mode=cv2.BORDER_CONSTANT, p=.4),
		OneOf([
...
if __name__ == '__main__':
	...
	clr_triangular = CyclicLR(mode='triangular2', step_size=4000, base_lr=6e-4, max_lr=1e-5)
	callbacks_list = [
	...
	model.summary()
	model.load_weights('landsat_weights_with_boundary_256_deeplabv3_xception_aug_e08_iou0.7096.h5')
