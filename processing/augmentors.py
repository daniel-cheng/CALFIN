...
class CLAHE(Operation):
    ...
    def __init__(self, probability, clipLimit=4.0, tileGridSize=(8, 8)):
    ...
    def clahe(self, img, clipLimit=2.0, tileGridSize=(8,8)):
    ...
    def perform_operation(self, image):
        self.clahe(img, self.clipLimit, self.tileGridSize)
