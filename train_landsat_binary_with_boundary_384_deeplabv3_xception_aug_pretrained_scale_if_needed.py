...
from data_landsat_binary_with_boundary_384_scale_if_needed import create_unagumented_data_from_image, load_validation_data
...
if __name__ == '__main__':
    ...
    model.compile(optimizer=AdamAccumulate(lr=1e-3, accum_iters=8), loss=bce_jaccard_loss, metrics=['binary_crossentropy', iou_score, 'accuracy'])
    model.load_weights('landsat_weights_with_boundary_384_deeplabv3_xception_aug_scale_if_needed_e33_iou0.7029.h5')
    model.summary() 
