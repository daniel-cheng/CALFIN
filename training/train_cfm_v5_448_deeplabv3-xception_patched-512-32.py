...
if __name__ == '__main__':
	...
	base_model = Deeplabv3(input_shape=(img_size, img_size,3), classes=16, OS=16, backbone='xception')
	...
	model.compile(optimizer=AdamAccumulate(lr=6e-5, accum_iters=8), loss=bce_ln_jaccard_loss, metrics=['binary_crossentropy', ln_iou_score, iou_score, 'accuracy'])
	model.summary()
