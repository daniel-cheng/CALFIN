...
if __name__ == '__main__':
	...
	print('-'*30)
	validation_data = load_validation_data(full_size, img_size, stride, regen=False)
	...
	ef_skip1 = Conv2D(16, (1, 1), padding='same', use_bias=False, name='ex_flow_feature_projection0')(partial_model)
