...
if __name__ == '__main__':
	...
	clr_triangular = CyclicLR(mode='triangular2', step_size=12000, base_lr=6e-5, max_lr=1e-5)
	callbacks_list = [
	...
	model.compile(optimizer=Adam(lr=3e-5), loss=bce_jaccard_loss, metrics=['binary_crossentropy', iou_score, 'accuracy'])
	model.summary()
	model.load_weights('landsat_weights_with_boundary_256_deeplabv3_xception_aug_e01_iou0.8457.h5')
