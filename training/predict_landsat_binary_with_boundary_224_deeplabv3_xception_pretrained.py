...
#	preprocess_input = get_preprocessing(BACKBONE)
	...
	model_checkpoint = ModelCheckpoint('landsat_weights_with_boundary_256_deeplabv3_xception_e{epoch:02d}_iou{val_iou_score:.4f}.h5', monitor='val_iou_score', save_best_only=False)
...
#		pass
	...
	base_model = Deeplabv3(input_shape=(224,224,3), classes=1, backbone='xception')
	...
	model.summary()
#		model.load_weights('landsat_weights_with_boundary_224_deeplabv3_xception_e17_iou0.9695.h5')
...
#	validation_path = 'landsat_raw_boundaries/validation_full'
...
#						# sum_result += result / 4.0
#						
#				imsave(os.path.join(pred_path, name[0:-4] + '_raw.png'), img)
#				imsave(os.path.join(pred_path, name[0:-4] + '_mask.png'), mask_edge)
#				imsave(os.path.join(pred_path, name[0:-4] + '_pred.png'), (result * 255.0).astype(np.uint8))
	...
	print('-'*30)
	pred_path = 'landsat_preds_boundaries/test_full_224'
