...
def load_validation_data(img_size):
    #If padded validation/train images have not yet been generated, do so now
    if not os.path.exists('cfm_validation_imgs_padded_' + str(img_size) + '.npy'):
        input_data_path = 'data/validation_original'
        output_data_path = 'data/validation_padded_' + str(img_size)
        os.mkdir(output_data_path)
        create_validation_data_from_directory(input_data_path, output_data_path, img_size)
    if not os.path.exists('data/train_padded_' + str(img_size)):
        input_data_path = 'data/train_original'
        output_data_path = 'data/train_padded_' + str(img_size)
        os.mkdir(output_data_path)
