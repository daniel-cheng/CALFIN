...
if __name__ == '__main__':
	...
	base_model = Deeplabv3(input_shape=(img_size, img_size,3), classes=16, OS=16, backbone='xception', weights=None)
	partial_model = base_model(inputs)
	
	feature_maps = _xception_block(partial_model, [32, 32, 32], 'exit_flow_block3',
	...
	ef_skip1 = Conv2D(32, (1, 1), padding='same', use_bias=False, kernel_regularizer=l1_l2(1e-5, 1e-5), name='ex_flow_feature_projection0')(partial_model)
	...
	densely_connected_fc_full_model = Conv2D(1, (1, 1), padding='same', kernel_regularizer=l1_l2(1e-5, 1e-5), name='exit_flow_last_depthwise')(concatenated_feature_maps)
