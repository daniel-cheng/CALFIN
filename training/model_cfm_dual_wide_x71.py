...
#			atrous_rates = (6, 12, 18)
		...
		x, skip2 = _xception_block(x, [256, 256, 256], 'entry_flow_block2',#112
								   skip_connection_type='conv', stride=1,
								   depth_activation=False, return_skip=True)
		x, skip3 = _xception_block(x, [256, 256, 256], 'entry_flow_block3',#112-56
								   skip_connection_type='conv', stride=2,
								   depth_activation=False, return_skip=True)
		x, skip4 = _xception_block(x, [728, 728, 728], 'entry_flow_block4',#56
							skip_connection_type='conv', stride=1,
							depth_activation=False, return_skip=True)
		x, skip5 = _xception_block(x, [728, 728, 728], 'entry_flow_block5',#56-28
							skip_connection_type='conv', stride=2,
							depth_activation=False, return_skip=True)
		skip6 = x #28
		for i in range(8):
	...
	if backbone == 'xception':
		...
		dec_skip0 = Conv2D(96, (1, 1), padding='same',
						   use_bias=False, kernel_regularizer=l1_l2(1e-6, 1e-6), name='feature_projection0')(skip6)
		...
		dec_skip1 = Conv2D(64, (1, 1), padding='same',
						   use_bias=False, kernel_regularizer=l1_l2(1e-6, 1e-6), name='feature_projection1')(skip4)
		...
		dec_skip2 = Conv2D(48, (1, 1), padding='same',
						   use_bias=False, kernel_regularizer=l1_l2(1e-6, 1e-6), name='feature_projection2')(skip2)
