...
from model_cfm_dual_wide_x71 import Deeplabv3, _xception_block
...
if __name__ == '__main__':
	...
	model_checkpoint = ModelCheckpoint('cfm_weights_patched_dual_wide_x71_' + str(img_size) + '_e{epoch:02d}_iou{val_iou_score:.4f}.h5', monitor='val_iou_score', save_best_only=False)
