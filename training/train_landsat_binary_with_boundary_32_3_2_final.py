...
if __name__ == '__main__':
	...
	#	print('-'*30)
		model.load_weights('landsat_weights_with_boundary_256_32-3-2_0.37071.h5')
		...
		model.compile(optimizer=Adam(lr=1e-4), loss='binary_crossentropy', metrics=['binary_crossentropy', dice_coef])
		#model.load_weights('landsat_weights_with_boundary_256_32-3-2_0.34976.h5')
