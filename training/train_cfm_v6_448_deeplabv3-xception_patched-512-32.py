...
if __name__ == '__main__':
	...
	model.compile(optimizer=AdamAccumulate(lr=3e-5, accum_iters=8), loss=bce_ln_jaccard_loss, metrics=['binary_crossentropy', iou_score, 'accuracy'])
	model.summary()
	model.load_weights('cfm_weights_patched_448_e16_iou0.4194.h5')
