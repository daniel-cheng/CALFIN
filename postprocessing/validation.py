...
def print_calfin_domain_metrics(settings, metrics):
	...
	for domain in metrics['domain_mean_deviations_pixels'].keys():
		...
		domain_std_deviation_points_pixels = np.nanstd(metrics['domain_validation_distances_pixels'][domain]) / sqrt_point_samples
		domain_std_deviation_points_meters = np.nanstd(metrics['domain_validation_distances_meters'][domain]) / sqrt_image_samples
		domain_std_deviation_images_pixels = np.nanstd(metrics['domain_mean_deviations_pixels'][domain]) / sqrt_point_samples
		domain_std_deviation_images_meters = np.nanstd(metrics['domain_mean_deviations_meters'][domain]) / sqrt_image_samples
		...
		domain_std_edge_iou_score = np.nanstd(metrics['domain_validation_edge_ious'][domain]) / sqrt_image_samples
		domain_std_mask_iou_score = np.nanstd(metrics['domain_validation_mask_ious'][domain]) / sqrt_image_samples
...
def print_calfin_all_metrics(settings, metrics):
	...
	std_deviation_points_pixels = np.nanstd(metrics['validation_distances_pixels']) / sqrt_point_samples
	std_deviation_points_meters = np.nanstd(metrics['validation_distances_meters']) / sqrt_image_samples
	std_deviation_images_pixels = np.nanstd(metrics['mean_deviations_pixels']) / sqrt_point_samples
	std_deviation_images_meters = np.nanstd(metrics['mean_deviations_meters']) / sqrt_image_samples
	std_edge_iou_score = np.nanstd(metrics['validation_edge_ious']) / sqrt_image_samples
	std_mask_iou_score = np.nanstd(metrics['validation_mask_ious']) / sqrt_image_samples
