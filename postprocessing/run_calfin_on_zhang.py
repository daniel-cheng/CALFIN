...
def initialize(img_size):
    ...
    validation_files = glob.glob(r"../training/data/validation_zhang/*modified.png")
    
    #Initialize output folders
    dest_root_path = r"../outputs/calfin_on_zhang"
    ...
    settings['log_file_name'] = 'logs_calfin_on_zhang.txt'
